...
\begin{figure}[tbp]
	...
	\caption[Positional relationship of ID PMTs and OD PMTs in a supermodule frame]{\label{SK_IDODPMT} Positional relationship of ID PMTs and OD PMTs in a supermodule frame~\cite{1997ZoaPhD}. 12 ID PMTs and 2 OD PMTs are attached in a supermodule frame, basically.}
\end{figure}
...
\begin{figure}[h]
	...
	\caption[Schematic view of Helmholtz coils]{\label{SK_Coil} Schematic view of Helmholtz coils~\cite{1998YamaguchiPhD}.}
\end{figure}
...
\begin{figure}[tbp]
	...
	\caption[Picture of a shockwave prevention case]{\label{SK_Case} Picture of a shockwave prevention case~\cite{SKaccident}.}
\end{figure}
